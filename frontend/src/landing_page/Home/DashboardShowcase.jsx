...
function DashboardShowcase() {
    return (
        <div className='container py-5 my-4'>
            <div className='row align-items-center bg-light p-5 rounded-4 shadow-sm border' style={{
                background: "linear-gradient(135deg, #FFFFFF 0%, #F8FAFC 100%)",
                borderColor: "#E2E8F0"
            }}>
                <div className='col-lg-6 mb-4 mb-lg-0'>
                    <span className='badge bg-success bg-opacity-10 text-success fw-bold px-3 py-2 mb-3'>
                        TERMINAL PREVIEW
                    </span>
                    ...
                    <p className='text-muted mb-4' style={{ lineHeight: "1.7" }}>
                        Monitor your watchlist, view real-time market depth quotes, analyze stock performance with Chart.js, and place instant buy/sell orders in a clean, modern interface.
                    </p>
                    
                    <div className='d-flex flex-column gap-3 mb-4'>
                        <div className='d-flex align-items-center gap-3'>
                            <div className='bg-primary bg-opacity-10 text-primary p-2 rounded-3 fw-bold'>✓</div>
